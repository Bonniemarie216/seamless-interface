...
export const MyTableDesktopRow: React.FC<{ strategy: Address; hideBorder?: boolean }> = ({ strategy, hideBorder }) => {
  const {
  ...
  return (
    <TableRow
      ...
      className={`hidden md:grid grid-cols-22 cursor-pointer items-center border-solid min-h-[148px] ${hideBorder ? "" : "border-b border-b-navy-100"}`}
    >
